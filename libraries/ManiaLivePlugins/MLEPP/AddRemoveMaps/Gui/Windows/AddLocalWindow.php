<?php
namespace ManiaLivePlugins\MLEPP\AddRemoveTracks\Gui\Windows;
...
class AddLocalWindow extends \ManiaLive\Gui\Windowing\ManagedWindow
{
	//components ...
	private $navigator;
	private $table;
	...
	function initializeComponents()
	{
		...
		$this->panel->setTitle('Server Tracks');
		$this->setMaximizable();
