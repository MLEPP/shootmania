            ...
            while($data = fgets($this->socket, 4096)) {
                ...
                if($data != "\n") {
                    ...
                    if($this->joined == false && (strstr($data,'MOTD') || strstr($data,'message of the day'))) {
                        ...
                        if($this->config->operCredentials != 'User Pass') {
                            $this->write('OPER '.$this->config->operCredentials);
                        }
                        
                        if($this->config->operChghost != 'test.test.net') {
                            $this->write('CHGHOST '.$this->config->operChghost);
                        }
